...
def training_loop(
        ...
        resume_pkl='/content/network-withdiff.pkl15',     # Network pickle to resume training from, None = train from scratch.
    ...
    while cur_nimg < total_kimg * 1000:
        ...
        if cur_tick < 0 or cur_nimg >= tick_start_nimg + sched.tick_kimg * 1000 or done:
            ...
            misc.save_pkl((G, D, Gs), dnnlib.make_run_dir_path('network.pkl%-5d'%cur_tick))
